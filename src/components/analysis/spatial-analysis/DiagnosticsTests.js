            ...
            <Table size="small">
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell align="right">{renderValue(moran_i.I || moran_i.value)}</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>P-value</TableCell>
                  <TableCell align="right">{renderValue(moran_i['p-value'] || moran_i.p_value)}</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </TableContainer>
